...
add wave -noupdate -radix ufixed /proc_tb/dut/proc_de/write_reg_ex
add wave -noupdate -radix ufixed /proc_tb/dut/proc_de/read_register1_ex
add wave -noupdate -radix ufixed /proc_tb/dut/proc_de/read_register2_ex
add wave -noupdate /proc_tb/dut/interrupt_latch
add wave -noupdate -color Gold /proc_tb/dut/interrupt
...
WaveRestoreCursors {{Cursor 1} {585000 ps} 0}
...
update
WaveRestoreZoom {521263 ps} {625713 ps}
