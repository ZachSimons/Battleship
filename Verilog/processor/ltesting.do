...
add wave -noupdate /proc_tb/dut/proc_fe/imem_out
...
add wave -noupdate /proc_tb/dut/proc_fe/stall_pc
add wave -noupdate /proc_tb/dut/hazard
add wave -noupdate -childformat {{{/proc_tb/dut/proc_de/REGFILE/regfile[30]} -radix decimal} {{/proc_tb/dut/proc_de/REGFILE/regfile[3]} -radix decimal} {{/proc_tb/dut/proc_de/REGFILE/regfile[2]} -radix decimal} {{/proc_tb/dut/proc_de/REGFILE/regfile[1]} -radix hexadecimal} {{/proc_tb/dut/proc_de/REGFILE/regfile[0]} -radix decimal}} -subitemconfig {{/proc_tb/dut/proc_de/REGFILE/regfile[30]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/REGFILE/regfile[3]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/REGFILE/regfile[2]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/REGFILE/regfile[1]} {-height 15 -radix hexadecimal} {/proc_tb/dut/proc_de/REGFILE/regfile[0]} {-height 15 -radix decimal}} /proc_tb/dut/proc_de/REGFILE/regfile
...
add wave -noupdate /proc_tb/dut/proc_fe/halt
add wave -noupdate /proc_tb/dut/halt_wb_fe
...
add wave -noupdate -radix decimal -childformat {{{/proc_tb/dut/proc_de/imm[4]} -radix decimal} {{/proc_tb/dut/proc_de/imm[3]} -radix decimal} {{/proc_tb/dut/proc_de/imm[2]} -radix decimal} {{/proc_tb/dut/proc_de/imm[1]} -radix decimal} {{/proc_tb/dut/proc_de/imm[0]} -radix decimal}} -subitemconfig {{/proc_tb/dut/proc_de/imm[4]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/imm[3]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/imm[2]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/imm[1]} {-height 15 -radix decimal} {/proc_tb/dut/proc_de/imm[0]} {-height 15 -radix decimal}} /proc_tb/dut/proc_de/imm
...
add wave -noupdate -radix decimal /proc_tb/dut/proc_ex/EXE_ALU/inA
add wave -noupdate -radix decimal /proc_tb/dut/proc_ex/EXE_ALU/inB
add wave -noupdate /proc_tb/dut/proc_ex/EXE_ALU/alu_op
add wave -noupdate /proc_tb/dut/proc_ex/EXE_ALU/option_bit
add wave -noupdate -radix decimal /proc_tb/dut/proc_ex/EXE_ALU/out
...
add wave -noupdate /proc_tb/dut/proc_forward/mem_wb_reg_write
add wave -noupdate /proc_tb/dut/proc_forward/ex_mem_reg_write
add wave -noupdate /proc_tb/dut/proc_forward/id_ex_reg_reg1
add wave -noupdate /proc_tb/dut/proc_forward/id_ex_reg_reg2
add wave -noupdate /proc_tb/dut/proc_forward/mem_wb_reg
add wave -noupdate /proc_tb/dut/proc_forward/ex_mem_reg
add wave -noupdate /proc_tb/dut/proc_forward/ignore_fwd_ex
add wave -noupdate /proc_tb/dut/proc_forward/instruction_ex
add wave -noupdate /proc_tb/dut/proc_forward/forward_control1
add wave -noupdate /proc_tb/dut/proc_forward/forward_control2
add wave -noupdate /proc_tb/dut/proc_forward/r_type
add wave -noupdate /proc_tb/dut/proc_ex/wbdata_wb_ex
add wave -noupdate -radix decimal /proc_tb/dut/proc_ex/alu_result_mem
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {421429 ps} 0}
...
update
WaveRestoreZoom {195788 ps} {594959 ps}
